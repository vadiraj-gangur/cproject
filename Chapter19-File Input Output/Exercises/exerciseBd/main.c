...
int main()
{
    FILE *sf, *df;
    /*Source File*/
    sf = fopen("D://LET US C//Chapter19-File Input Output//Examples//example2//new.txt", "r");
    /*Destination File*/
    df = fopen("D://LET US C//Chapter19-File Input Output//Examples//example2//new_3.txt", "w");
